...
function plugin_init_irg(){
    ...
    // $plugin_hooks['api_device_save']['irg'] = 'irg_api_device_save';
...
function plugin_irg_install(){
    ...
    api_plugin_register_realm('irg', 'irg.php', 'IRG', 1);
    api_plugin_register_realm('irg', 'irg_cacti_api.php', 'IRG Cacti API', 1);
    ...
    api_plugin_register_realm('irg', 'irg_cacti_controler.php', 'Controler', 1);
    ...
    // api_plugin_register_hook('irg', 'api_device_save', 'irg_api_device_save', 'setup.php');
...
function irg_draw_navigation_text($nav){
    $nav["irg.php:"] = array("title" => "Inox Report Generator", "mapping" => "index.php:", "url" => "irg.php", "level" => "1");
   
    $nav["sample_report.php:"] = array("title" => "Sample Report", "mapping" => "irg.php:", "url" => "sample_report.php", "level" => "2");
       
    $nav["make_report.php:"] = array("title" => "Make Report", "mapping" => "irg.php:", "url" => "make_report.php", "level" => "2");
          
    $nav["report_archives.php:"] = array("title" => "Report Archives", "mapping" => "irg.php:", "url" => "report_archives.php", "level" => "2");
    
    $nav["exclude.php:"] = array("title" => "Excluded Periods", "mapping" => "irg.php:", "url" => "exclude.php", "level" => "2");
        
    $nav["api_doc.php:"] = array("title" => "API Documentation", "mapping" => "irg.php:", "url" => "doc/api_doc.php:", "level" => "2");
                         
   return $nav;
}

function irg_api_device_save($save){
    if(isset($_POST['irg']))
        $save["irg"] = form_input_validate($_POST['irg'], "irg", "", true, 3);
    else
        $save['irg'] = form_input_validate('', "irg", "", true, 3);
    return $save;
}
